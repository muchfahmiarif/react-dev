...
const DetailProduct = () => {
  ...
  return (
    <div className="w-100 min-h-screen flex justify-center items-center">
      {Object.keys(product).length > 0 ? ( // Object.keys(product).length > 0 untuk mengecek apakah product sudah terisi atau belum
        <div className="flex font-sans">
          ...
          <form className="flex-auto p-6">
            <div className="flex flex-wrap">
              ...
              <div className="w-full flex-none text-sm font-medium text-slate-700 mt-2">Review {product.rating.rate}/5</div>
              <div className="w-full flex-none text-sm font-medium text-slate-700 mt-2">{product.rating.count} orang</div>
            </div>
